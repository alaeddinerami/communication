...
export default function NotificationCard(){
    ...
    const [content , Setcontent] = useState('sent you a message!')


    return(

        <div className="relative flex items-center w-full p-3 rounded-r-3xl border-b border-gray-600 cursor-pointer transition-colors duration-200 dark:hover:bg-gray-800 gap-x-2 hover:bg-gray-100 focus:outline-none group">
