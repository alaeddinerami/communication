    ...
    <>
      <aside className="flex w-full">
        <div className="navi flex flex-col items-center w-20 h-screen py-8 space-y-8 bg-red-900 dark:border-gray-700">
          ...
          <Link to={'/home'} className="p-1.5 text-gray-500 transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
          ...
          <button onClick={logout} className="p-1.5 text-gray-500 transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
