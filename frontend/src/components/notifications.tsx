  ...
  return (
   ...
   <div className="h-screen py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-70 dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="mt-8 space-y-4">
            ...
            <div className="flex items-center w-full  px-5 py-2 border-b transition-colors duration-200 dark:hover:bg-gray-800 gap-x-2 hover:bg-gray-100 focus:outline-none">
